...
const Sidebar = () => {
  return (
    <div className='h-[750px] w-20 p-8 bg-[#EDEFF2] border-2 border-r-gray-200 hidden lg:block'>
        <div className='flex flex-col justify-between items-center h-full'>

<div className='part1 space-y-2'>
...
<div className='part-2 space-y-2 '>

<Image src={img1} className='bg-purple-200 rounded-full'>
