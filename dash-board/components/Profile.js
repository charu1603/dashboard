...
const Profile = () => {
  return (
    <div className='w-80 h-[750px] flex flex-col bg-[#EDEFF2] hidden md:block font-[Roboto] '>
         <div className='flex  justify-between p-4'>
         <button className='flex items-center justify-center h-8 w-8 bg-white rounded-full'>
         <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 28 29" fill="none">
...
<Image src={User} width={100} height={100} className='rounded-full' />
</div>
<div className='flex flex-col items-center justify-center text-xs font-bold'>
    <h2 className='p-2'>Hello, alfred</h2>
    <p className='p-2'>kakdechaitrali16@gmail.com</p>
</div>

<div className='flex p-4 justify-center'>
    <div className='flex flex-col items-center'>
    <div className='flex flex-col items-center justify-center h-28 w-28  border-2 border-gray-200 rounded-tl-lg'>
...
</svg> <h3 className='text-xs text-gray-400'>Dashboard</h3>
    </div>
    <div className='flex flex-col items-center justify-center h-28 w-28  border-2 border-l-gray-200 border-b-gray-200 '>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M16 12.5H6C5.45 12.5 5 12.95 5 13.5C5 14.05 5.45 14.5 6 14.5H16C16.55 14.5 17 14.05 17 13.5C17 12.95 16.55 12.5 16 12.5ZM16 8.5H6C5.45 8.5 5 8.95 5 9.5C5 10.05 5.45 10.5 6 10.5H16C16.55 10.5 17 10.05 17 9.5C17 8.95 16.55 8.5 16 8.5ZM6 18.5H12C12.55 18.5 13 18.05 13 17.5C13 16.95 12.55 16.5 12 16.5H6C5.45 16.5 5 16.95 5 17.5C5 18.05 5.45 18.5 6 18.5ZM25.21 14.71L25.3 14.8C25.69 15.19 25.69 15.82 25.3 16.21L19.72 21.8C19.33 22.19 18.7 22.19 18.31 21.8L15.22 18.71C15.0327 18.5232 14.9275 18.2695 14.9275 18.005C14.9275 17.7405 15.0327 17.4868 15.22 17.3L15.31 17.21C15.7 16.82 16.33 16.82 16.72 17.21L19.02 19.51L23.8 14.72C24.18 14.32 24.82 14.32 25.21 14.71V14.71Z" fill="#C3CAD9"/>
</svg> <h3 className='text-xs text-gray-400'>Dashboard</h3>
    </div>
    <div className='flex flex-col items-center justify-center h-28 w-28 border-2 border-l-gray-200 border-b-gray-200 rounded-bl-lg'>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
...
</svg><h3 className='text-xs text-gray-400'>Dashboard</h3></div>
...
<div className='flex flex-col items-center justify-center h-28 w-28 border-2 border-l-gray-200 border-b-gray-200 rounded-bl-lg'>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M23 7.5H7C5.9 7.5 5.01 8.4 5.01 9.5L5 21.5C5 22.6 5.9 23.5 7 23.5H23C24.1 23.5 25 22.6 25 21.5V9.5C25 8.4 24.1 7.5 23 7.5ZM22.6 11.75L15.53 16.17C15.21 16.37 14.79 16.37 14.47 16.17L7.4 11.75C7.15 11.59 7 11.32 7 11.03C7 10.36 7.73 9.96 8.3 10.31L15 14.5L21.7 10.31C22.27 9.96 23 10.36 23 11.03C23 11.32 22.85 11.59 22.6 11.75Z" fill="#C3CAD9"/>
    ...
    <div className='flex flex-col items-center'>
    <div className='flex flex-col items-center justify-center h-28 w-28 border-2 border-t-gray-200 border-r-gray-200 rounded-tr-lg '>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M16 12.5H6C5.45 12.5 5 12.95 5 13.5C5 14.05 5.45 14.5 6 14.5H16C16.55 14.5 17 14.05 17 13.5C17 12.95 16.55 12.5 16 12.5ZM16 8.5H6C5.45 8.5 5 8.95 5 9.5C5 10.05 5.45 10.5 6 10.5H16C16.55 10.5 17 10.05 17 9.5C17 8.95 16.55 8.5 16 8.5ZM6 18.5H12C12.55 18.5 13 18.05 13 17.5C13 16.95 12.55 16.5 12 16.5H6C5.45 16.5 5 16.95 5 17.5C5 18.05 5.45 18.5 6 18.5ZM25.21 14.71L25.3 14.8C25.69 15.19 25.69 15.82 25.3 16.21L19.72 21.8C19.33 22.19 18.7 22.19 18.31 21.8L15.22 18.71C15.0327 18.5232 14.9275 18.2695 14.9275 18.005C14.9275 17.7405 15.0327 17.4868 15.22 17.3L15.31 17.21C15.7 16.82 16.33 16.82 16.72 17.21L19.02 19.51L23.8 14.72C24.18 14.32 24.82 14.32 25.21 14.71V14.71Z" fill="#3361FF"/>
</svg><h3 className='text-xs text-gray-400'>Dashboard</h3>
    </div>
    <div className='flex flex-col items-center justify-center h-28 w-28  border-2 border-gray-200 '>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M23 7.5H7C5.9 7.5 5.01 8.4 5.01 9.5L5 21.5C5 22.6 5.9 23.5 7 23.5H23C24.1 23.5 25 22.6 25 21.5V9.5C25 8.4 24.1 7.5 23 7.5ZM22.6 11.75L15.53 16.17C15.21 16.37 14.79 16.37 14.47 16.17L7.4 11.75C7.15 11.59 7 11.32 7 11.03C7 10.36 7.73 9.96 8.3 10.31L15 14.5L21.7 10.31C22.27 9.96 23 10.36 23 11.03C23 11.32 22.85 11.59 22.6 11.75Z" fill="#C3CAD9"/>
    ...
    <div className='flex flex-col items-center justify-center h-28 w-28  border-2 border-l-gray-200 border-b-gray-200 border-r-gray-200 rounded-br-lg '>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="31" viewBox="0 0 30 31" fill="none">
...
</svg><h3 className='text-xs text-gray-400'>Dashboard</h3></div></div>

</div>

<div className='part-3 flex items-center justify-center w-40 h-8  ml-12 mt-4 rounded-full border-2 border-gray-200 '>
